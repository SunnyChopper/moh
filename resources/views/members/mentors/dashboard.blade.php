		...
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12">
				<div class="gray-box">
					...
					<h6 class="text-center mb-3"><i class="fa fa-instagram mr-2"></i><strong>Instagram: </strong> @mindofhabit</h6>
					{{-- <h6 class="text-center mb-3"><i class="fa fa-twitter mr-2"></i><strong>Twitter: </strong> {INSERT_TWITTER_USERNAME}</h6> --}}
					<h6 class="text-center mb-0"><i class="fa fa-envelope mr-2"></i><strong>Email: </strong> <a href="mailto:jeremy@mindofhabit.com">jeremy@mindofhabit.com</a></h6>
				</div>
			</div>
		</div>
	</div>
