	...
	<div class="container mt-64 mb-64 mt-32-mobile mb-32-mobile">
		<div class="row">
			<div class="col-lg-10 offset-lg-1 col-lg-offset-1 col-md-10 offset-md-1 col-md-offset-1 col-sm-12 col-xs-12 col-12">
				<div class="gray-box">
					<h3 class="text-center">New Premium Content</h3>
					<p class="text-center"><b>Note: </b>Fields with <span class="red">*</span> are required.</p>
					<form action="/admin/premium/create" method="post" id="new_premium_content_form">
						{{ csrf_field() }}
						...
						<div class="form-group">
							...
							<textarea id="blog_textarea" name="body" class="form-control" rows="15" form="new_premium_content_form"></textarea>
						</div>

						<div class="form-group">
							<input type="submit" value="Create Premium Content" class="btn btn-success">
						</div>
					</form>
				</div>
			</div>
