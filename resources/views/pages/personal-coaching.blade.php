...
@section('content')
	...
	<div class="container pt-64 pb-64">
        <div class="row">
            <div class="col-12">
                <h2>Become the Master of Yourself, Not the Other Way Around</h2>
            </div>
        </div>
		...
		<div class="row justify-content-center">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <h4>Conquer the Self and You Can Achieve Anything You Want</h4>
        ...
        <div class="container pt-64 pb-64">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    <img src="https://image.flaticon.com/icons/svg/1636/1636025.svg" class="centered regular-image-50">
                    <h5 class="mt-16 text-center">Appointments</h5>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    <img src="https://image.flaticon.com/icons/svg/1660/1660882.svg" class="centered regular-image-50">
                    <h5 class="mt-16 text-center">Recommendations</h5>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    <img src="https://image.flaticon.com/icons/svg/185/185983.svg" class="centered regular-image-50">
                    <h5 class="mt-16 text-center">Personalized Videos</h5>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    <img src="https://image.flaticon.com/icons/svg/1039/1039328.svg" class="centered regular-image-50">
                    <h5 class="mt-16 text-center">Shared Documents</h5>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    <img src="https://image.flaticon.com/icons/svg/254/254043.svg" class="centered regular-image-50">
                    <h5 class="mt-16 text-center">Direct Messaging</h5>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    <img src="https://image.flaticon.com/icons/svg/1055/1055672.svg" class="centered regular-image-50">
                    <h5 class="mt-16 text-center">Assigned Tasks</h5>
    ...
    <div style="background: #24252a;">
        <div class="container pt-32 pb-32">
            <div class="row">
                <div class="col-12">
                    <h4 class="text-center white">30-Day Money Back Guarantee</h4>
                    <p class="text-center white mb-0">We're so confident that you will see progress in mastering yourself that we're going to offer you a 30-day money back guarantee. If you don't see any sliver of progress, you can contact us and we'll get you your money back.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 mt-32-mobile">
                <div class="gray-box">
                    <form id="enroll_personal_coaching_form" action="/personal-coaching/enroll" method="POST">
                        {{ csrf_field() }}
                        <h4 class="text-center mb-16">Master Your Self</h4>
                        @if(Auth::guest())
