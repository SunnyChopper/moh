				...
				<div class="gray-box">
					<form id="update_course_module_form" action="/admin/courses/modules/update" method="POST">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="title" value="<?php echo e($module->title); ?>" required>
						</div>

						<div class="form-group">
							<h5>Description:</h5>
							<p class="mb-2">If someone clicks to get more information about a module, this is the description that will show.</p>
							<textarea class="form-control" name="description" form="update_course_module_form" rows="5" required><?php echo e($module->description); ?></textarea>
						</div>
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" name="order" value="<?php echo e($module->order); ?>" required>
						</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/moh/resources/views/admin/courses/modules/edit.blade.php ENDPATH**/ ?>